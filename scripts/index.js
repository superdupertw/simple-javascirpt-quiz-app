...
function initApp() {
    ...
    quiz = new Quiz(
        ...
        `This question are only the basic part of javascript, and im sure you guys can get this correct in no sweat, i only make this quis to learn about DOM and CSS animation thanks guys.`,
        70,
        questions);
